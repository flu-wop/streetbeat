...
// Film site footer — same structure as MCS, strong cross-link back to midcitysound.com.
// Ecosystem: Mid City Sound + Donald Markowitz + Fire on the Bayou.
...
// Real Instagram handles from the site
const SOCIALS = [
